...
export default {
  ...
  render(createElement, context) {
    ...
    return (
      <i {...iProps}>
        <svg class="icon svg-icon" id="iconerror" viewBox="0 0 1024 1024">
          <path d="M512 725.333333a68.266667 68.266667 0 1 1 0 136.533334 68.266667 68.266667 0 0 1 0-136.533334z"></path>
